...
client.on("guildMemberAdd", (member) => {
    ...
    guild.fetchInvites().then(invites => {
        ...
        if(channel){
       channel.send(`${member} Sunucuya Katıldı, <a:tac:799581772882247680> Davet Eden ** ${invite.inviter.username}** <a:RainbowElmasGif:765563694540390410> (**${total + bonus}** Daveti Var <a:Onaylamak2Gif:765563788010717194>)`)
        }
    }).catch();
});
